...
class Repositorio {
    ...
    //Utilizado para pesquisar as data com feriado no banco
    function verificarFeriado($VO) {

        $query = "select TO_CHAR(DT_FERIADO, 'dd/mm/yyyy') DT_DIA_FERIADO from DATA_FERIADO where DT_FERIADO = TO_DATE('" . $VO->DT_DIA_FERIADO . "', 'dd/mm/yyyy')";
