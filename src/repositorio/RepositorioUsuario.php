...
class RepositorioUsuario extends Repositorio {
	...
	function verificaGrupo($VO){
		...
		$query = "select * from v_perfil_usuario where id_sistema = 8 AND nb_modulo in (1,2,3,4) and ID_USUARIO = ".$VO->ID_USUARIO;
	...
	function verificaPermissao($VO){
		...
		$query = "select cs_nivel_acesso from v_perfil_usuario where id_sistema = 8 and nb_modulo = ".$VO->NB_MODULO." and nb_programa = ".$VO->NB_PROGRAMA." and id_usuario = ".$VO->ID_USUARIO;
