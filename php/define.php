...
switch ($srv){
    ...
    $titulo 		= 'Gestão de PBPG - Prefeitura de Manaus';
	$urlcss 		= $url.'css/';
	$urlimg 		= $url.'img/';
	$pathvo 		= $path.'src/vo/';
	$pathimg 		= $path.'img/';
...
//Se nao estiver logado redireciona para  pagina de login
	if(!$_SESSION['usuario'] && $projeto."src/autenticacao/index.php" != $_SERVER['PHP_SELF'] && strpos($_SERVER['PHP_SELF'], 'sbpg_public') > 0 ){
